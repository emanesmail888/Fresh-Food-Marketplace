...
<template>
    <header class="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-30">
        <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4 sm:gap-2" :class="{ 'flex-row-reverse': isRTL }">
            ...
            <!-- Right side -->
            <div class="flex items-center gap-5 sm:gap-3" :class="{ 'flex-row-reverse': isRTL }">
                ...
                <!-- Logout Button -->
                <button @click="logout"
                    class="bg-green-600 text-white hover:bg-green-700 transition-colors flex items-center rounded-md px-2 py-2 text-sm"
                    :class="{ 'flex-row-reverse': isRTL }">
                    <svg class="w-5 h-5" :class="{ 'ml-1': !isRTL, 'mr-1': isRTL }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
